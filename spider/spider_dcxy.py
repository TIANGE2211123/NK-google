...
# 2021年初至今的南开新闻
url_list = [f'https://news.nankai.edu.cn/dcxy/system/count//0005000/000000000000/000/000/c0005000000000000000_000000{i}.shtml' for i in range(1, 525)]
            ...
            async with httpx.AsyncClient(follow_redirects=True, timeout=10,
                ...
                if url.startswith('http') or url.startswith('https'):
                    ...
                    try:
                        ...
                        async with aiofiles.open(f'./nk_dcxy/{title}.html', mode='w', encoding='utf-8') as file:
