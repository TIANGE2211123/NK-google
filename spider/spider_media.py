...
url_list = [f'https://news.nankai.edu.cn/mtnk/system/count//0006000/000000000000/000/000/c0006000000000000000_000000{i}.shtml' for i in range(1,749)]
    ...
    "Referer": "https://news.nankai.edu.cn/",
                ...
                if url.startswith('http') or url.startswith('https'):
                    ...
                    try:
                       ...
                       # url_df.to_csv("./nk_media2.csv", mode='a', header=not os.path.exists("./nk_media2.csv"))
                    # 爬取的网页存在问题
